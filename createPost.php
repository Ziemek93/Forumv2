...
$chck = htmlspecialchars($_GET['sec'], ENT_QUOTES);
		...
		global $section;
			...
			<div class= 'indexList'>
				<div class = 'messTextDiv'>
					...
					<input type = 'hidden' name = 'topicLink' value = '".$chck."' />
						<textarea name='postContent' cols='500' rows='20' placeholder = 'Tekst'></textarea>  
